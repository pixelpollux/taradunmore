...
export default function HeaderNav() {
	...
	return (
		<nav
			ref={navRef}
			className='flex flex-col bg-[var(--bg)] lg:flex-row justify-center items-center gap-4 lg:gap-8 text-lg lg:text-xl font-sans font-bold sticky z-[50] top-0 lg:mb-24 border-b-[var(--text)] border-b-[.15rem] px-8 py-4 lg:px-12 lg:py-7'
		>
			{" "}
